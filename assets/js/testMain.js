...
const questions = [
  ...
  {
    type: "short",
    question: "How are called the home animals?",
    correct: "pets",
  },
  ...
  {
    type: "mcq",
    question: "Choose the correct plural: One child, two ___",
    options: ["childs", "children", "childes", "childrens"],
    correct: 1,
  },
  {
    type: "short",
    question: "Fill in: She ___ (to be) my best friend.",
    correct: "is",
  },
  {
    type: "mcq",
  ...
  { type: "short", question: "Write the past of 'go'", correct: "went" },
  {
    ...
    options: ["Slowly", "Fast", "Lazy", "Late"],
    correct: 1,
  },
  {
    type: "short",
    question: "Complete: He has lived here ___ 2010.",
    correct: "since",
  },
  {
    type: "mcq",
  ...
  {
    type: "short",
    question: "Write the comparative form of 'good'",
    correct: "better",
  },
  {
    type: "mcq",
    question:
      "Choose the correct conditional: If I ___ you, I would apologize.",
    options: ["was", "were", "am", "be"],
    correct: 1,
  },
  {
    type: "short",
    question: "Fill in: She said she ___ (finish) the project by Monday.",
    correct: "would finish",
  },
  {
    type: "mcq",
    question: "Which word is closest in meaning to 'reluctant'?",
    options: ["Willing", "Unwilling", "Excited", "Eager"],
    correct: 1,
  },
  ...
  {
    type: "short",
    question: "Write the passive voice: They built the house in 1990.",
...
document.addEventListener("keydown", (e) => {
  ...
  if (e.key === "Enter" && !e.shiftKey) {
    ...
    if (resultsBtn.style.display === "none" && nextBtn.style.display === "none")
      return;
